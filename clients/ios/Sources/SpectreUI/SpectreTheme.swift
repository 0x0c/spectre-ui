...
public struct SpectreTheme {
    ...
    public static let defaultColors: [String: Color] = [
        ...
        "surface": Color.spectreSurface,
        "onSurface": .primary,
        "surfaceVariant": Color.spectreSurfaceVariant,
        "onSurfaceVariant": .secondary,
        "background": Color.spectreBackground,
        "onBackground": .primary,
        "outline": Color.spectreSeparator,
        "outlineVariant": Color.spectreSeparator.opacity(0.5),
        "error": .red,
        "onError": .white,
        "success": .green,
        "onSuccess": .white,
