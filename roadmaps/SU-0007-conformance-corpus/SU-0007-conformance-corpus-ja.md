...
コーパスのケースは、仕様上の疑問を決着させる最も安い場所でもあります。バインディングが欠けているときに
...
- **ランタイムごとに単体テストを書き、一致はレビューで確認する。** 却下します。一致するかどうかが、
...
- [SU-0002 — M1、iOS / Android のクライアントSDK](../SU-0002-m1-client-sdks/SU-0002-m1-client-sdks-ja.md) — 100%通す必要があるSDKです。
